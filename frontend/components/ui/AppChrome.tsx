...
const styles = StyleSheet.create({
  eyebrow: { fontFamily: "sans-bold", fontSize: 11, textTransform: "uppercase", letterSpacing: 1.1, color: Colors.teal },
  headingRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  title: { fontFamily: "sans-bold", fontSize: 28, letterSpacing: -0.8, color: Colors.foreground },
  subtitle: { fontFamily: "sans-regular", fontSize: 14, lineHeight: 20, color: Colors.mutedForeground },
  iconButton: { width: 46, height: 46, borderRadius: 16, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.card },
  ...
  sectionTitle: { fontFamily: "sans-bold", fontSize: 19, letterSpacing: -0.3, color: Colors.foreground },
  link: { fontFamily: "sans-semibold", fontSize: 13, color: Colors.teal },
  metric: { flex: 1, minWidth: 92, borderRadius: 20, padding: 14, backgroundColor: Colors.card, borderWidth: 1, borderColor: Colors.border, gap: 5 },
  metricIcon: { width: 34, height: 34, borderRadius: 12, alignItems: "center", justifyContent: "center", marginBottom: 3 },
  metricValue: { fontFamily: "sans-bold", fontSize: 19, color: Colors.foreground },
  metricLabel: { fontFamily: "sans-medium", fontSize: 11, color: Colors.mutedForeground },
  empty: { alignItems: "center", borderWidth: 1, borderColor: Colors.border, borderRadius: 24, padding: 28, backgroundColor: Colors.card, gap: 8 },
  emptyIcon: { width: 54, height: 54, borderRadius: 18, backgroundColor: Colors.paleTeal, alignItems: "center", justifyContent: "center", marginBottom: 4 },
