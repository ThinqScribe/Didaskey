...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "sans-bold", fontSize: 28, letterSpacing: 0, color: Colors.foreground },
  subtitle: { fontFamily: "sans-regular", fontSize: 14, lineHeight: 20, color: Colors.mutedForeground },
  iconButton: { width: 44, height: 44, borderRadius: 22, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.card },
  ...
  sectionTitle: { fontFamily: "sans-bold", fontSize: 19, letterSpacing: 0, color: Colors.foreground },
  link: { fontFamily: "sans-semibold", fontSize: 13, color: Colors.teal },
  metric: { flex: 1, minWidth: 92, borderRadius: 8, padding: 14, backgroundColor: Colors.card, borderWidth: 1, borderColor: Colors.border, gap: 5 },
  metricIcon: { width: 34, height: 34, borderRadius: 8, alignItems: "center", justifyContent: "center", marginBottom: 3 },
